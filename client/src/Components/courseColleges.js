...
class CourseColleges extends Component{
    ...
    super(props);
    this.fetchCourseColleges(this.props.match.params.name)
  }

  fetchCourseColleges = (course) => {
    let url = 'https://oneshot-ai-harsha.herokuapp.com/courses/'+course;
    axios.get(url).then((response) =>{
       this.setState({colleges:response.data[0].colleges})
    });
  };
